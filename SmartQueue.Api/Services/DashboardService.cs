...
namespace SmartQueue.Api.Services
{
    public class DashboardService : IDashboardService
    {
        ...
        public DashboardService(SmartQueueDbContext dbContext, IMemoryCache cache)
        {
        ...
        {
            return await cache.GetOrCreateAsync("dashboard_data", async entry =>
            {
